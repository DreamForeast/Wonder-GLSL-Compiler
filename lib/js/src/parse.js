...
function _getAllImportContent(fileName, segmentName, segmentContent, map) {
  ...
  var _get = function (fileNameList, segmentName, segmentContent, map) {
    var recordList = _execRegex(_createImportFlagRe(/* () */0), segmentContent, 0, /* [] */0, (function (startIndex, recordList) {
            return /* :: */[
                    /* tuple */[
                      startIndex,
            ...
            return /* :: */[
                    /* tuple */[
                      startIndex,
                      result.index,
                      Caml_option.nullable_to_opt(Js_null_undefined.bind(Caml_array.caml_array_get(result, 1), (function (importFileName) {
                                  ...
                                  if (extname === "") {
                                    ...
                                    if (match) {
                                      ...
                                      var match$2 = Js_dict.get(map, importFileName);
                                      if (match$2 !== undefined) {
                                        var segmentMap = Caml_option.valFromOption(match$2);
                                        var fileName = segmentMap["fileName"];
                                        var newFileNameList = /* :: */[
                                          fileName,
                                          fileNameList
                                        ];
                                        if (List.mem(fileName, fileNameList)) {
                                          ...
                                          var match$3 = Js_dict.get(segmentMap, segmentName);
                                          if (match$3 !== undefined) {
                                            var importContent = match$3;
                                            if (_createImportFlagRe(/* () */0).test(importContent)) {
